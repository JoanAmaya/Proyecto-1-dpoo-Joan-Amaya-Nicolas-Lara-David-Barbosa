    ...
    public void addRestaurantUsage()
    {
        ...
        while (sentinel)
        {
            ...
            if (PoB.equals("platos"))
            {
                ...
                String Lugar = input("Digite el lugar en el que quiere ordenar (puede ser 'Restaurante del hotel' o 'Habitacion' )");
            ...
            else if (PoB.equals("bebidas"))
            {
                ...
                String LugarB = input("Digite el lugar en el que quiere ordenar (puede ser 'Restaurante del hotel' o 'Habitacion' )");
